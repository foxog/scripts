...
#where the stuff is
script_url="https://raw.githubusercontent.com/foxog/scripts/blob/master/"
...
curl -sLO --sock5 10.10.10.104:1081 ${script_url}firmware.sh
rc0=$?
curl -sLO --sock5 10.10.10.104:1081 ${script_url}functions.sh
rc1=$?
curl -sLO --sock5 10.10.10.104:1081 ${script_url}sources.sh
rc2=$?
